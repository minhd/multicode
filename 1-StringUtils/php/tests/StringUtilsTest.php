...
class StringUtilsTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals("equipmentClassName", SU::camelize("equipment class name"));
        $this->assertEquals("equipmentClassName", SU::camelize("equipment class Name"));
        $this->assertEquals("equipmentClassName", SU::camelize("equipment Class name"));
        $this->assertEquals("equipmentClassName", SU::camelize("equipment Class Name"));
        $this->assertEquals("equipmentClassName", SU::camelize("Equipment class name"));
        ...
        $this->assertEquals("equipmentClassName", SU::camelize("Equipment Class name"));
        $this->assertEquals("equipmentClassName", SU::camelize("Equipment Class Name"));
        $this->assertEquals("equipmentClassName", SU::camelize("equipment className"));
        $this->assertEquals("equipmentClassName", SU::camelize("equipment ClassName"));
        $this->assertEquals("equipmentClassName", SU::camelize("Equipment ClassName"));
        $this->assertEquals("equipmentClassName", SU::camelize("equipmentClass name"));
        $this->assertEquals("equipmentClassName", SU::camelize("equipmentClass Name"));
        $this->assertEquals("equipmentClassName", SU::camelize("EquipmentClass Name"));
    }
